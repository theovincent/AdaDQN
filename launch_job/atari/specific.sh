...
SHARED_ARGS="--first_seed 1 --last_seed 3 --n_parallel_seeds 2 --replay_buffer_capacity 1_000_000 --batch_size 32 \
    ...
    --n_initial_samples 20_000 --cnn_n_layers_range 1 5 --cnn_n_channels_range 16 128 --cnn_kernel_size_range 2 10 \
    --cnn_stride_range 1 5 --mlp_n_layers_range 0 2 --mlp_n_neurons_range 25 1024 --learning_rate_range 6 3"

for TARGET_UPDATE_FREQUENCY in 1_000 4_000 8_000
do
    ...
    do
        ...
        do
            ...
            do
                ...
                launch_job/lunar_lander/cluster_adadqn.sh --experiment_name tuf_$TARGET_UPDATE_FREQUENCY\_huf_$HP_UPDATE_FREQUENCY\_$EXPLOITATION_TYPE\_$RESET_MODE \
