...
# for HP_UPDATE_FREQUENCY in 10_000 # 2_000 10_000 15_000
# do
...
# do
#     launch_job/lunar_lander/cluster_searldqn.sh --experiment_name min_steps_eval_$MIN_STEPS_EVALUATION\_elitism_reset_full_train \
...
#     launch_job/lunar_lander/cluster_searldqn.sh --experiment_name min_steps_eval_$MIN_STEPS_EVALUATION\_truncation_reset_full_train \
