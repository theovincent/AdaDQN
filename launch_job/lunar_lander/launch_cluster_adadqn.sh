...
then
    ...
    launch_job/lunar_lander/train_adadqn.sh -e $EXPERIMENT_NAME $BASE_ARGS $ADADQN_ARGS -g"
else
    ...
    --output=experiments/lunar_lander/logs/$EXPERIMENT_NAME/AdaDQN/train_adadqn_%a.out \
    launch_job/lunar_lander/train_adadqn.sh -e $EXPERIMENT_NAME $BASE_ARGS $ADADQN_ARGS"
fi
